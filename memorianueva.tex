...
\usepackage{babel}          % Habilitar reglas de separación silábica en español
...
Este trabajo se enfoca en el estudio y la aplicación de la arquitectura Transformer para la predicción de series de tiempo financieras, específicamente en el contexto de un sistema de trading de criptomonedas. Se desarrolla un modelo Transformer capaz de procesar indicadores técnicos para optimizar decisiones de compra y venta en el par BTC/USDT. La importancia de este enfoque radica en la capacidad del Transformer para capturar dependencias a largo plazo en datos secuenciales, lo que representa una ventaja comparativa en un mercado estocástico y ruidoso. El lector encontrará una revisión del estado del arte, la implementación del modelo, su evaluación frente a una estrategia de ``comprar y esperar'', y un análisis de los desafíos de los datos financieros. Se aplican conceptos de aprendizaje profundo, redes neuronales y análisis de series de tiempo para la optimización de estrategias algorítmicas.
\end{abstract}
