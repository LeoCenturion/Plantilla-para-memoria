...
En este capítulo se desarrolla la solución alcanzada. Se describen los datos que se procesaron, las estrategias que se probaron, así como el criterio que se uso para compararlas. También se agregan detalles sobre el diseño de la implementación del bot de trading.
...
\begin{itemize}
    ...
    \item Validación de modelos basados en árboles: El éxito de XGBoost en el trabajo de referencia sirvió como validación para su uso como un componente eficaz en nuestra arquitectura final, en conjunto con los \textit{embeddings} generados por Chronos.
\end{itemize}
...
\section{Implementación de la Arquitectura Propuesta}
...
\begin{enumerate}
    ...
    \item Cada serie se procesó con un modelo Chronos pre-entrenado para extraer los \textit{embeddings} de sus capas ocultas. Estos \textit{embeddings} son vectores de alta dimensionalidad que encapsulan la información contextual y los patrones temporales aprendidos por el Transformer.
    \item Los \textit{embeddings} resultantes de todos los indicadores se concatenaron para formar un único vector de características.
