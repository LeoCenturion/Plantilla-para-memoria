...
\begin{titlepage}
  % Fecha y lugar
   % Ejemplo: Ciudad de Córdoba, junio de 2025
    ...
    \begin{flushright}
        ...
        \vspace*{6.5cm} % Ajustar según la posición vertical deseada

        % Título
        {\fontfamily{phv}\bfseries\fontsize{33pt}{40pt}\selectfont
          Predicción de series de tiempo aplicado al trading de criptomonedas usando la arquitectura de Transformers} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Martín Leonardo Centurión} \\[1cm]
        ...
        \textbf{Director:} Dr. Camilo Argoty} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
          Esp. Ing. Pablo Martín Gomez Verdini (FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
          Esp. Lic. Bárbara Cocco (FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
          Esp. Ing. Maria Fabiana Cid (FIUBA)} \\[2cm]
