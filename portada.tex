...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        {\fontfamily{phv}\bfseries\fontsize{33pt}{40pt}\selectfont
          Predicción de series de tiempos aplicado al trading de criptomonedas usando la arquitectura de Transformers} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Martin Leonardo Centurion} \\[1cm]
        ...
        \textbf{Director:} Camilo Argoty} \\[1cm]
